...
/**
 * WarehouseInventoryAddition entity representing inventory additions/receipts
 */
@Entity
...
public class WarehouseInventoryAddition {
    ...
    private TransactionType transactionType = TransactionType.RECEIPT;
    ...
    // Constructors
    public WarehouseInventoryAddition() {
        // Default constructor
    }

    public WarehouseInventoryAddition(Warehouse warehouse, Product product, Integer quantity) {
        this();
