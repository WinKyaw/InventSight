...
/**
 * DTO for picking up a transfer and starting delivery
 */
public class PickupTransferDTO {
    ...
    // Constructors
    public PickupTransferDTO() {
    }
    
    public PickupTransferDTO(String carrierName, String carrierPhone, String carrierVehicle, LocalDateTime estimatedDeliveryAt) {
